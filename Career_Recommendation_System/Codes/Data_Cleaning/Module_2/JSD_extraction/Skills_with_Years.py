...
unique_file('Junior Software Engineer.txt','Junior Software Engineer_skills_with_years.txt','Junior Software Engineer_Years.txt','Junior Software Engineer_Skills.txt')
